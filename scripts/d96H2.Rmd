...
d96_pouch$Brk_expression <- ifelse(brk$brk > 0.2, "High", "Low")
...
```{r}
d96_dp$Brk_expression <- ifelse(brk$brk > 0.2, "High", "Low")
...
pouch_hinge$Brk_expression <- ifelse(brk$brk > 0.2, "High", "Low")
